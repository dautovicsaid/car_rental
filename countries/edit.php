...
if (isset($_GET['id'])) {
    ...
    $sql = generateSelectQuery("countries", ["id" => $id]);
...
<head>
    ...
    <title>Car Rental - Countries edit</title>
</head>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 offset-3 mt-3">
                <form action="update.php" id="countryForm" method="POST" onsubmit="validateCountry(event)">
