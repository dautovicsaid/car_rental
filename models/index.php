        ...
        <div class="row mt-5">
            <div class="col-5 offset-2">
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT car_models.* , brands.name as brand_name from car_models join brands on brands.id=brand_id";
            ...
            <div class="col-3 offset-2">
                <a class="btn btn-primary btn-block" href="create.php">Add new model</a>
            </div>
        </div>
    </div>
